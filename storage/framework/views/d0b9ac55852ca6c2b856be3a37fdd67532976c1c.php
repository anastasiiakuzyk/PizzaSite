                        ...
                        <?php $__currentLoopData = $pizzas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__env->startComponent('Components.orderItem'); ?>
                                ...
                                <?php $__env->slot('count'); ?>
                                    <?php echo e($item->pivot->count); ?>

                                <?php $__env->endSlot(); ?>
                                <?php $__env->slot('ingredients'); ?>
                                    <?php $__currentLoopData = $item->ingredients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($iitem->name); ?>,
...
<?php echo $__env->renderComponent(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $cpizzas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__env->startComponent('Components.orderItem'); ?>
                                <?php $__env->slot('name'); ?>
                                    <?php echo e($item['size']); ?> зібрана піцца
                                <?php $__env->endSlot(); ?>
                                <?php $__env->slot('price'); ?>
                                    <?php echo e($item['price']); ?>
...
<?php /**PATH /var/www/html/resources/views/cartContent.blade.php ENDPATH**/ ?>