    ...
    <div class="form">
        ...
        <form action="<?php echo e(route('comment.add')); ?>" method="post">
            ...
            <div class="user_info">
                ...
                <input type="text" name="email" placeholder="E-mail" class="input textblock" required>
            </div>
...
<?php /**PATH /var/www/clients/client43/web50/web/resources/views/mainPageContent.blade.php ENDPATH**/ ?>