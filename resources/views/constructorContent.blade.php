<script>
    const toping = {!! $ingredients->toJson() !!};
</script>
<div class="container">
    <div class="result">
                    ...
                    <div class="template_sizes">
                        <div id="small-size" value="80" class="size">
                            <div class="size_img_section">
                                <img src="{{asset('/images/constructor/medium.svg')}}" class="medium_size_img" />
                            </div>
                            <p>Середня (60грн)</p>
                        </div>
                        <div id="big-size" value="100" class="size">
                            <div class="size_img_section">
                                <img class="big_size_img" src="{{asset('/images/constructor/big.svg')}}" />
                            </div>
                            <p>Велика (80грн)</p>
                        </div>
                    </div>
                    <div class="toping__wrapper">
                        <div class="toping__grid">
                            @foreach($ingredients as $item)
                                <div class="toping" value="{{$item->id}}">{{$item->name}} ({{$item->price}}грн)</div>
                            @endforeach
                        </div>
                    </div>
                    <div class="toping__wrapper">
